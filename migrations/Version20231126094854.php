 ...
 */
final class Version20231126094854 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE abonnement CHANGE VerificationCode verification_code INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE abonnement CHANGE verification_code VerificationCode INT NOT NULL');
    }
}
