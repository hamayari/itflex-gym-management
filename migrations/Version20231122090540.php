 ...
 */
final class Version20231122090540 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer CHANGE dateDebOffer datedeboffer DATETIME NOT NULL, CHANGE dateFinOffer datefinoffer DATETIME NOT NULL, CHANGE img img VARCHAR(255) DEFAULT NULL, CHANGE nbReservation nb_reservation INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE abonnement ADD CONSTRAINT FK_351268BBFE6E88D7 FOREIGN KEY (idUser) REFERENCES user (Id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE abonnement ADD CONSTRAINT FK_351268BB4EAC3B26 FOREIGN KEY (typeAbon) REFERENCES type_abonn (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE offer CHANGE datedeboffer dateDebOffer DATE NOT NULL, CHANGE datefinoffer dateFinOffer DATE NOT NULL, CHANGE img img VARCHAR(255) NOT NULL, CHANGE nb_reservation nbReservation INT NOT NULL');
