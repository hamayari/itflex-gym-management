 ...
 */
final class Version20231108013254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP FOREIGN KEY comment_ibfk_1');
        $this->addSql('ALTER TABLE comment DROP idUser, CHANGE content content VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE post CHANGE id_User idUser INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD idUser INT NOT NULL, CHANGE content content VARCHAR(150) NOT NULL');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT comment_ibfk_1 FOREIGN KEY (idPost) REFERENCES post (idPost)');
        ...
        $this->addSql('ALTER TABLE post CHANGE idUser id_User INT NOT NULL');
